use super::{
    message_model::{ClientMessage, Connect, Disconnect, Join, ListRooms, Message},
    session,
};
use actix::prelude::*;
...
impl Handler<Connect> for ChatServer {
    ...
    fn handle(&mut self, msg: Connect, _: &mut Context<Self>) -> Self::Result {
        ...
        self.send_message(
            "main",
            &json!({"value":vec![format!("{}",id)],"chat_type":session::ChatType::CONNECT})
                .to_string(),
            0,
        );
